...
object Ontology {
  ...
  @OntologyProperty(label = "The away team for a game",
    domain = "http://www.stellman-greene.com/pbprdf#Game",
    range = "http://www.stellman-greene.com/pbprdf#Team")
  @OntologyObjectProperty
  val AWAY_TEAM = valueFactory.createURI(NAMESPACE, "awayTeam")

  @OntologyProperty(label = "The home team roster for a game",
    domain = "http://www.stellman-greene.com/pbprdf#Game",
  ...
  @OntologyProperty(label = "The away team roster for a game",
    domain = "http://www.stellman-greene.com/pbprdf#Game",
    range = "http://www.stellman-greene.com/pbprdf#Roster")
  @OntologyObjectProperty
  ...
  @OntologyProperty(label = "The game time of an event (eg. 9:37)",
    domain = "http://www.stellman-greene.com/pbprdf#Event",
    range = "http://www.w3.org/2001/XMLSchema#string")
  val TIME = valueFactory.createURI(NAMESPACE, "time")

  @OntologyProperty(label = "The period the event occurred in",
    domain = "http://www.stellman-greene.com/pbprdf#Event",
  ...
  @OntologyProperty(label = "The number of seconds into a game that an event occurred",
    domain = "http://www.stellman-greene.com/pbprdf#Event",
    range = "http://www.w3.org/2001/XMLSchema#int")
  ...
  @OntologyProperty(label = "The home player contesting the jump ball",
  ...
  @OntologyProperty(label = "The away player contesting the jump ball",
    domain = "http://www.stellman-greene.com/pbprdf#JumpBall",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  val JUMP_BALL_AWAY_PLAYER = valueFactory.createURI(NAMESPACE, "jumpBallAwayPlayer")

  @OntologyProperty(label = "The player who gained possession of the jump ball",
    domain = "http://www.stellman-greene.com/pbprdf#JumpBall",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  ...
  @OntologyProperty(label = "The player who rebounded the ball",
    domain = "http://www.stellman-greene.com/pbprdf#Rebound",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  @OntologyObjectProperty
  val REBOUNDED_BY = valueFactory.createURI(NAMESPACE, "reboundedBy")

  @OntologyProperty(label = "Determines if a foul or rebound is offensive",
  ...
  @OntologyProperty(label = "True if a shot was made",
  ...
  @OntologyProperty(label = "The player that attempted the shot",
    domain = "http://www.stellman-greene.com/pbprdf#Shot",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  @OntologyObjectProperty
  val SHOT_BY = valueFactory.createURI(NAMESPACE, "shotBy")

  @OntologyProperty(label = "The type of shot",
    domain = "http://www.stellman-greene.com/pbprdf#Shot",
    range = "http://www.w3.org/2001/XMLSchema#string")
  ...
  @OntologyProperty(label = "The player that assisted the shot",
    domain = "http://www.stellman-greene.com/pbprdf#Shot",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  @OntologyObjectProperty
  val SHOT_ASSISTED_BY = valueFactory.createURI(NAMESPACE, "shotAssistedBy")

  @OntologyProperty(label = "The number of points scored by the shot",
    domain = "http://www.stellman-greene.com/pbprdf#Shot",
    range = "http://www.w3.org/2001/XMLSchema#int")
  ...
  @OntologyProperty(label = "The player that blocked the shot",
    domain = "http://www.stellman-greene.com/pbprdf#Shot",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  @OntologyObjectProperty
  ...
  @OntologyProperty(label = "Determines if a foul is a loose ball foul",
    domain = "http://www.stellman-greene.com/pbprdf#Foul",
    range = "http://www.w3.org/2001/XMLSchema#boolean")
  ...
  @OntologyProperty(label = "Determines if a foul is a charge",
    domain = "http://www.stellman-greene.com/pbprdf#Foul",
    range = "http://www.w3.org/2001/XMLSchema#boolean")
  ...
  @OntologyProperty(label = "Determines if a technical foul is a three second violation",
  ...
  @OntologyProperty(label = "Determines if a technical foul is a delay of game violation",
    domain = "http://www.stellman-greene.com/pbprdf#TechnicalFoul",
    range = "http://www.w3.org/2001/XMLSchema#boolean")
  ...
  @OntologyProperty(label = "The technical foul number for a player",
    domain = "http://www.stellman-greene.com/pbprdf#TechnicalFoul",
    range = "http://www.w3.org/2001/XMLSchema#int")
  ...
  @OntologyProperty(label = "The type of turnover",
  ...
  @OntologyProperty(label = "The player who stole the ball",
    domain = "http://www.stellman-greene.com/pbprdf#Turnover",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  @OntologyObjectProperty
  val STOLEN_BY = valueFactory.createURI(NAMESPACE, "stolenBy")

  @OntologyProperty(label = "The player who turned the ball over",
    domain = "http://www.stellman-greene.com/pbprdf#Turnover",
    range = "http://www.stellman-greene.com/pbprdf#Player")
  @OntologyObjectProperty
