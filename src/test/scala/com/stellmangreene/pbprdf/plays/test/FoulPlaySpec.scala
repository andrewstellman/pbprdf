    ...
    rep.executeQuery("SELECT * { <http://www.stellman-greene.com/pbprdf/401031716/47> ?p ?o }")
      ...
      .toSet should be(
        Set(
          ...
          "http://www.stellman-greene.com/pbprdf#secondsIntoGame -> 1124",
          "http://www.stellman-greene.com/pbprdf#secondsLeftInPeriod -> 316",
    ...
    rep.executeQuery("SELECT * { <http://www.stellman-greene.com/pbprdf/401031716/68> ?p ?o }")
      ...
      .toSet should be(
        Set(
          ...
          "http://www.stellman-greene.com/pbprdf#secondsIntoGame -> 1276",
