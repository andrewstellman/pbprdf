"""Shared fixtures for quality tests.

Re-exports the same fixtures used by tests/conftest.py so that
quality/test_functional.py can run independently with `pytest quality/`.
"""
